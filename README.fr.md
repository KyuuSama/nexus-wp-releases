...
> *Développé par [Studium Officium](https://www.studiumofficium.com/)*
...
12. **`if`** & **`nx_if`** : Portes logiques conditionnelles pour afficher un contenu uniquement si une valeur existe (or si elle n'existe pas via l'attribut `not="true"`).
...
| L'Atelier (Intégrateur de Code) | Générateur de Composants (Hub Cards) |
| :---: | :---: |
| ![L'Atelier](screenshots/NexusXP_screen_09.png) | ![Hub Cards](screenshots/NexusXP_screen_08.png) |

| L'Arsenal (Widgets & Surcharges) | Logistique & Console Cloud |
| :---: | :---: |
| ![L'Arsenal](screenshots/NexusXP_screen_03.png) | ![Console Cloud](screenshots/NexusXP_screen_13.png) |

👉 **[Consulter les captures d'écran dans la galerie screenshots/](screenshots/)**
...
* **Licence :** Logiciel Propriétaire / Cœur Gratuit avec Moteur SaaS (Tous droits réservés).
* **Copyright :** © 2026 **Studium Officium**. Tous droits réservés.
* **Site Officiel :** [https://www.studiumofficium.com/](https://www.studiumofficium.com/)
* **Développeur :** Studium Officium
* 💛 **Soutenir le Projet :** [Faire un don via PayPal](https://paypal.me/CHIMENTITHOMAS)
